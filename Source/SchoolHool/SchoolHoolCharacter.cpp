...
void ASchoolHoolCharacter::NotifyControllerChanged()
{
...
void ASchoolHoolCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ASchoolHoolCharacter::Move);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &ASchoolHoolCharacter::Look);
	}
	else
	{
...
void ASchoolHoolCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ASchoolHoolCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
